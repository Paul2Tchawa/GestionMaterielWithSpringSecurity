...
```
cd existing_repo
git remote add origin https://gitlab.com/fouomenedaniel/gestionmateriel.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fouomenedaniel/gestionmateriel/-/settings/integrations)
